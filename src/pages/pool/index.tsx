        ...
        <section className="flex flex-col grow w-full max-w-[1200px] px-5 mx-auto mb-20">
          ...
          <div className="flex items-stretch gap-3">
            <div className="flex-auto w-3/5">
              <PoolPanel />
              {/* bottom */}
              <article className="p-5 mx-auto mt-5 border shadow-lg dark:shadow-none bg-paper rounded-2xl">
                ...
                <div className="mt-3 mb-3 text-base text-left text-primary-lighter">
                  When providing liquidity to the liquidity bins of the Chromatic protocol,
                  providers are rewarded by minting CLB tokens. CLB tokens follow the ERC-1155
                  standard and have one token contract per market, with each bin having its own
                  unique token ID.{' '}
