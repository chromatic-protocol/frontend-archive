...
export const CurvedButton = (props: CurvedButtonProps) => {
  ...
  return (
    <button
      className={`relative border-none w-[53px] h-[53px] rounded-full text-primary-lighter hover:text-primary-light overflow-hidden ${
...
const CurvedLineBg = (props: CurvedLineBgProps) => {
  ...
  return (
    ...
    >
      <path
        className="fill-gray-lighter dark:fill-transparent"
        fillRule="evenodd"
