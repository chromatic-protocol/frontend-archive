...
export const PopoverArrow = (props: PopoverArrowProps) => {
  ...
  return (
    <span
      className={`inline-block relative border-none w-[53px] h-[53px] rounded-full text-primary-lighter hover:text-primary-light overflow-hidden cursor-pointer ${className}`}
      onClick={onClick}
    >
  ...
  return (
    ...
    >
      ...
      <path
        ...
        clipRule="evenodd"
        className="translate-x-1 fill-white"
      />
    </svg>
  );
};
