...
export const Empty: Story = {
  args: {
    ...
    positions: [
      ...
      {
        marketAddress: '',
        lossPrice: BigNumber.from(888),
        profitPrice: BigNumber.from(888),
        status: 'closing',
        toProfit: BigNumber.from(888),
        collateral: BigNumber.from(888),
        toLoss: BigNumber.from(888),
        pnl: BigNumber.from(888),
        id: BigNumber.from(888),
        openVersion: BigNumber.from(888),
        closeVersion: BigNumber.from(888),
        qty: BigNumber.from(888),
        leverage: 18,
        openTimestamp: BigNumber.from(888),
        closeTimestamp: BigNumber.from(888),
        takerMargin: BigNumber.from(888),
        owner: '',
        _binMargins: [],
        _feeProtocol: 5,
        makerMargin: BigNumber.from(888),
        closePrice: BigNumber.from(888),
        openPrice: BigNumber.from(888),
      },
      {
        marketAddress: '',
        lossPrice: BigNumber.from(888),
